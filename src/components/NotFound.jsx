      ...
      <div className="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
        ...
        <div className="card-body p-sm-5 text-center">
          ...
          <p className="fs-12 fw-medium text-muted">
            Sorry, the page you are looking for can't be found. Please check the
            URL or try to a different page on our site.
          </p>
          <div className="mt-5">
            
            <Link to="/" className="btn btn-light-brand w-100">
              Back Home
            </Link>
          </div>
        </div>
