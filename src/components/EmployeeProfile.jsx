                  ...
                  <div className="border border-dashed border-gray-5 rounded mb-4 md-lg-0">
                    <div className="p-4">
                      <div className="d-sm-flex align-items-center">
                        ...
                        <div className="ms-0 mt-4 ms-sm-3 mt-sm-0">
                          <a href="javascript:void(0);" className="d-block">
                            Mailbox Platform Github
                          </a>
                          <div className="fs-12 d-block text-muted">
                            Development
                          </div>
                        </div>
                      </div>
                      <div className="my-4 text-muted text-truncate-2-line">
                        ...
                        Molestias dolorem necessitatibus temporibus nemo commodi
                        eaque dignissimos itaque unde hic, sed rerum doloribus
                        possimus minima nobis porro facilis voluptatum atque
                        asperiores perspiciatis saepe laboriosam rem cupiditate
                        libero sit.
                      </div>
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="img-group lh-0 ms-3">
                          ...
                          <a
                            href="javascript:void(0);"
                            className="avatar-text avatar-sm bg-soft-primary"
                            data-bs-toggle="tooltip"
                            data-bs-trigger="hover"
                            title="Explorer More"
                          >
                    ...
                    <div className="px-4 py-3 border-top border-top-dashed border-gray-5 d-flex justify-content-between gap-2">
                      ...
                      <span className="mx-2 text-gray-400 d-none d-md-block">
                        |
                      </span>
                      <a href="javascript:void(0);" className="fs-12 fw-bold">
                        View →
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="border border-dashed border-gray-5 rounded">
                    <div className="p-4">
                      <div className="d-sm-flex align-items-center">
                        ...
                        <div className="ms-0 mt-4 ms-sm-3 mt-sm-0">
                          <a href="javascript:void(0);" className="d-block">
                            Chatting Platform Figme
                          </a>
                          <div className="fs-12 text-muted">Design</div>
                        </div>
                      </div>
                      <div className="my-4 text-muted text-truncate-2-line">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
